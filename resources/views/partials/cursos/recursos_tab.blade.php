<div class="tab-pane fade" id="tab-recursos" role="tabpanel" aria-labelledby="recursos-tab">
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('CrearRecursos', $cursos->id) }}" class="btn btn-primary btn-sm">
                <i class="fas fa-plus me-1"></i> Nuevo Recurso
            </a>
            <a href="{{ route('ListaRecursosEliminados', $cursos->id) }}" class="btn btn-info btn-sm">
                    ...
                    <div class="col-md-5 col-lg-12">
                        <div class="card h-100 border">
                            ...
                            @if (isset($recurso->archivoRecurso))
                                <a href="{{ route('recursos.descargar', $recurso->archivoRecurso) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-download me-1"></i> Descargar
                                </a>
                                @endif
                                <a href="{{ route('editarRecursos', $recurso->id) }}" class="btn btn-sm btn-outline-warning">
                                    <i class="fas fa-edit me-1"></i> Editar
                                </a>
                                <a href="{{ route('quitarRecurso', $recurso->id) }}" class="btn btn-sm btn-outline-danger">
