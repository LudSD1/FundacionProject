                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="modalEditarRecursoLabel-{{ $recurso->id }}">Editar Recurso
                                                </h5>
                            ...
                            <div class="mt-3">
                                ...
                                @if ($actividad->tiposEvaluacion->contains('nombre', 'Cuestionario'))
                                    @role('Docente')
                                        ...
                                        <div class="modal fade" id="modalCuestionario-{{ $actividad->id }}"
                                            tabindex="-1" aria-labelledby="modalCuestionarioLabel-{{ $actividad->id }}"
                                            aria-hidden="true">
