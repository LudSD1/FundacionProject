        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="search-container">
                    ...
                    <input type="text" class="form-control search-input" placeholder="Buscar en foros..."
                        id="searchForums">
    ...
    @if ($foros->count() > 0)
        <div class="forums-grid" id="forumsGrid">
            @foreach ($foros as $foro)
                <div class="forum-card" data-forum-name="{{ strtolower($foro->nombreForo) }}"
                        ...
                        <div class="forum-actions">
                            ...
                            @if (auth()->user()->hasRole('Docente') || auth()->user()->hasRole('Administrador'))
                                <div class="admin-actions">
                                    ...
                                    <form class="d-inline" action="{{ route('quitarForo', encrypt($foro->id)) }}"
                                        method="POST"
