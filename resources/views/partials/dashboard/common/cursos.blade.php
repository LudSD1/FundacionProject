                    ...
                    @if(isset($inscritos) && $inscritos->count() > 0)
                        ...
                        @if (auth()->user()->id == $inscrito->estudiante_id && $inscrito->cursos && !$inscrito->cursos->deleted_at)
                            <div class="col-12 col-md-6 col-lg-4 course-item"
                                ...
                                data-type="{{ $inscrito->cursos->tipo ?? 'curso' }}"
                                ...
                                <div class="course-card">
                                    ...
                                    <div class="course-image">
                                        @php
                                            ...
                                            $imagenExiste =
                                                $imagenRuta && \Illuminate\Support\Facades\Storage::exists($imagenRuta);
                                        @endphp

                                        <img src="{{ $imagenExiste ? asset('storage/' . $imagenRuta) : asset('assets/img/course-default.jpg') }}"
                                            alt="{{ $inscrito->cursos->nombreCurso ?? 'Curso sin nombre' }}"
                                            loading="lazy">
                                        ...
                                        <div class="course-meta">
                                            ...
                                            @if ($inscrito->cursos->tipo == 'congreso')
                                                <span class="badge bg-success">
                                                    <i class="bi bi-ticket-perforated"></i> Gratuito
                                                </span>
                                            @endif
                                        </div>
                                            ...
                                            <div class="progress-section mb-3">
                                                ...
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar" role="progressbar"
                                                        ...
                                                        aria-valuenow="{{ $inscrito->progreso }}" aria-valuemin="0"
