...
<div class="mb-4">
    ...
    <div class="step-header mb-4">
        <h4 class="text-primary fw-bold mb-1"><i class="bi bi-trophy me-2"></i>Logros y Reconocimientos</h4>
        <p class="text-muted small">Gestiona los logros que los usuarios pueden obtener.</p>
    </div>
