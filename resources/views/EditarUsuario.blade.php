                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel"
                            ...
                            <div class="mt-3">
                                <form action="{{ route('EditarperfilUser', encrypt($usuario->id)) }}" method="POST">
                                    @csrf
                                    <h4 class="mb-4">Datos Personales de {{ $usuario->name }} {{ $usuario->lastname1 }}
                                        {{ $usuario->lastname2 }}</h4>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="lastname1" class="form-label">Apellido Paterno <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" value="{{ $usuario->lastname1 }}"
                                                name="lastname1">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="lastname2" class="form-label">Apellido Materno <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" value="{{ $usuario->lastname2 }}"
                                                name="lastname2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ $usuario->CI }}"
                                                name="ci">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $usuario->CiudadReside }}" name="CiudadReside">
                                        </div>
                                    </div>
                                    ...
                                    @if ($usuario->tutor)
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nombre"
                                                    name="nombreT" value="{{ $usuario->tutor->nombreTutor ?? '' }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="appT" class="form-label">Apellido Paterno</label>
                                                <input type="text" class="form-control" placeholder="Apellido Paterno"
                                                    name="appT" value="{{ $usuario->tutor->appaternoTutor ?? '' }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="apmT" class="form-label">Apellido Materno</label>
                                                <input type="text" class="form-control" placeholder="Apellido Materno"
                                                    name="apmT" value="{{ $usuario->tutor->apmaternoTutor ?? '' }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Cédula de Identidad"
                                                name="CIT" value="{{ $usuario->tutor->CI ?? '' }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Dirección"
                                                name="direccion" value="{{ $usuario->tutor->Direccion ?? '' }}">
                                        </div>
                                        ...
                                        @foreach ($atributosD as $atributosD)
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Formación Académica" name="formacion"
                                                        value="{{ $atributosD->formacion ?? '' }}">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="Especializacion" class="form-label">Experiencia
                                                        Laboral</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Experiencia Laboral" name="Especializacion"
                                                        value="{{ $atributosD->Especializacion ?? '' }}">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="ExperienciaL" class="form-label">Especialización</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Especialización" name="ExperienciaL"
                                ...
                                <div class="mt-3">
                                    ...
                                    <form action="{{ route('CambiarRolUser', encrypt($usuario->id)) }}" method="POST">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <strong>Usuario actual:</strong> {{ $usuario->name }} {{ $usuario->lastname1 }}
                                            {{ $usuario->lastname2 }}
                                            <br>
                                        ...
                                        <div class="mb-4">
                                            <label for="nuevo_rol" class="form-label">Seleccionar Nuevo Rol <span
                                                    class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <p class="card-text small">Acceso a cursos, materiales de estudio y
                                                                evaluaciones.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <p class="card-text small">Puede crear cursos, gestionar
                                                                estudiantes y calificar.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <p class="card-text small">Control total del sistema, gestión de
                                                                usuarios y configuraciones.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="confirmar_cambio"
                                                    name="confirmar_cambio" required>
