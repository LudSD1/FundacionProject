    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const animatedElements = document.querySelectorAll(
                '.forum-main-info, .forum-actions, .forum-breadcrumb');
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    if (!confirm(
                            '¿Estás seguro de que deseas eliminar este foro y todos sus mensajes?\nEsta acción no se puede deshacer.'
                            )) {
                        e.preventDefault();
                    }
                });
    ...
    <div class="container py-4">
        ...
        <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1500">
            ...
            @if (session('xp_earned'))
                <div class="toast show xp-toast" role="alert" aria-live="assertive" aria-atomic="true"
                    data-bs-delay="3000">
            ...
            @if (session('achievement'))
                <div class="toast show achievement-toast" role="alert" aria-live="assertive" aria-atomic="true"
                    data-bs-delay="4000">
            ...
            @if (session('level_up'))
                <div class="toast show level-up-toast" role="alert" aria-live="assertive" aria-atomic="true"
                    data-bs-delay="5000">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <span class="fw-bold">{{ $mensaje->estudiantes->name }}
                                                    {{ $mensaje->estudiantes->lastname1 }}
                                                    {{ $mensaje->estudiantes->lastname2 }}</span>
                                            </h5>
                                            ...
                                            <div class="card bg-light border-0 shadow-sm mb-3">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <h6 class="mb-1">
                                                                    ...
                                                                    {{ $respuesta->estudiantes->lastname1 }}
                                                                    {{ $respuesta->estudiantes->lastname2 }}
                                                                </h6>
                                                                <p class="text-muted small mb-0">
                                                        ...
                                                        <div class="dropdown">
                                                            <button class="btn btn-link text-muted btn-sm" type="button"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <form
                                                                        action="{{ route('foro.respuesta.delete', encrypt($respuesta->id)) }}"
                                                                        method="POST"
