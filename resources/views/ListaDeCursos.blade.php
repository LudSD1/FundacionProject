                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="search-box-table">
                            ...
                            <input type="text" class="form-control search-input-table"
                                placeholder="Buscar por nombre, docente, tipo..." id="searchInput">
                                ...
                                <tr class="curso-row" data-course-id="{{ $curso->id }}">
                                    ...
                                    <td>
                                        <div class="course-name-cell" data-bs-toggle="modal"
                                            data-bs-target="#courseModal{{ $curso->id }}" style="cursor: pointer;">
                                    ...
                                    <td>
                                        <div class="action-buttons-cell">
                                            ...
                                            <a class="btn-action-modern btn-view"
                                                href="{{ route('Curso', [encrypt($curso->id)]) }}" data-bs-toggle="tooltip"
                                                title="Ver detalles">
