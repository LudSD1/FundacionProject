                        ...
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                ...
                                <input type="number" name="cupos" id="cupos_input" class="form-control-modern"
                                    value="{{ old('cupos', '') }}" min="1" placeholder="Ej: 30" 
                                    {{ old('cupos') == '0' ? 'disabled' : '' }} required>
                                <input type="hidden" name="cupos" id="cupos_hidden" value="0" disabled>
                                <div class="helper-text-modern mt-1" id="cupos_helper" style="display: {{ old('cupos') == '0' ? 'block' : 'none' }};">
