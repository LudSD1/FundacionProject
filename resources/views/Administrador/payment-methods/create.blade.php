            ...
            <form action="{{ route('payment-methods.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror"
                                ...
                                <option value="mobile_payment" {{ old('type') == 'mobile_payment' ? 'selected' : '' }}>Pago Móvil</option>
                                <option value="digital_wallet" {{ old('type') == 'digital_wallet' ? 'selected' : '' }}>Billetera Digital</option>
                                <option value="cryptocurrency" {{ old('type') == 'cryptocurrency' ? 'selected' : '' }}>Criptomoneda</option>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              name="description"
                              rows="3"
                              placeholder="Descripción adicional del método de pago">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
