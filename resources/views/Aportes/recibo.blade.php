                ...
                <div class="info-section">
                    <div class="info-group">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $aporte->datosEstudiante ?? ($aporte->user->name ?? '') }}</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $aporte->created_at ? $aporte->created_at->format('d/m/Y') : '-' }}</span>
                        </div>
                        <div class="info-item">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr class="total-row">
                                ...
                                <td class="amount">{{ number_format($aporte->monto_pagado ?? $aporte->monto, 2) }} Bs</td>
                            </tr>
                            <tr>
                                <td>Restante a Pagar</td>
                                <td class="amount">{{ number_format(($aporte->monto - ($aporte->monto_pagado ?? $aporte->monto)), 2) }} Bs</td>
                            </tr>
                            <tr class="change-row">
                                <td>Cambio</td>
