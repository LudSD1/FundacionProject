            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <form method="GET" action="{{ route('lista.cursos.congresos') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="type" id="type" class="form-select">
                                    ...
                                    <option value="congreso" {{ request('type') == 'congreso' ? 'selected' : '' }}>Evento
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="sort" id="sort" class="form-select">
                                    ...
                                    <option value="date_desc" {{ request('sort') == 'date_desc' ? 'selected' : '' }}>Más
                                        recientes</option>
                        ...
                        <div class="row text-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="text-start">
                                        <h3 class="mb-0 fw-bold">
                                            {{ $stats['total_estudiantes'] ?? $cursos->sum('inscritos_count') }}+</h3>
                            ...
                            <div class="col-md-3 mb-3 mb-md-0">
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="text-start">
                                        <h3 class="mb-0 fw-bold">
                                            {{ $stats['categorias_disponibles'] ?? $categorias->count() }}+</h3>
                                    ...
                                    <div class="card h-100 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-muted">
                                                {{ Str::limit($curso->descripcionC ?? $curso->descripcion, 100) }}</p>
                                            ...
                                            @if ($curso->categorias && $curso->categorias->count() > 0)
                                                <div class="mb-2">
                                                    @foreach ($curso->categorias->take(2) as $categoria)
                                                        <span
                                                            class="badge bg-light text-dark me-1">{{ $categoria->name }}</span>
                                                    @endforeach
                                                    @if ($curso->categorias->count() > 2)
                                                        <span
                                                            class="badge bg-light text-dark">+{{ $curso->categorias->count() - 2 }}</span>
                                                    @endif
                                                </div>
                                            @endif
                                            ...
                                            <div class="mb-3">
                                                @if ($curso->tipo == 'Curso')
                                                    <small class="text-muted">
                                                        ...
                                                        <i
                                                            class="bi bi-people ms-3 me-1"></i>{{ $curso->inscritos_count ?? 0 }}
                                                        estudiantes
                                                    </small>
                                                @else
                                                    <small class="text-muted">
                                                        <i
                                                            class="bi bi-calendar me-1"></i>{{ \Carbon\Carbon::parse($curso->fecha_ini)->format('d M Y') }}
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between mb-2">
                                                        <div>
                                                            <span
                                                                class="badge bg-primary me-2">{{ ucfirst($curso->tipo) }}</span>
                                                            <span class="badge bg-success">{{ $curso->nivel }}</span>
                                                        ...
                                                        @if ($curso->calificaciones_avg_puntuacion)
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <small
                                                                    class="text-muted ms-1">({{ $curso->calificaciones_count }})</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    <h5 class="card-title">{{ $curso->nombreCurso }}</h5>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center">
                                                            @if ($curso->docente && $curso->docente->profile_photo_path)
                                                                <img src="{{ asset('storage/' . $curso->docente->profile_photo_path) }}"
                                                                    ...
                                                                    height="30" alt="{{ $curso->docente->name }}">
                                                            @else
                                                                <img src="{{ asset('assets/img/user.png') }}"
                                                                    class="rounded-circle me-2" width="30"
                                                                    height="30" alt="Instructor">
                                                            @endif
                                                            <small class="text-muted">
                                                                {{ $curso->docente ? $curso->docente->name . ' ' . $curso->docente->lastname1 : 'Instructor' }}
                                                            </small>
                                                        ...
                                                        <h5 class="text-primary mb-0">
                                                            Bs. {{ number_format($curso->precio, 2) }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
