                                ...
                                <div class="col-md-4">
                                    <div class="filter-group">
                                        ...
                                        <select name="type" id="type" class="form-select filter-select">
                                            ...
                                            <option value="curso" {{ request('type') == 'curso' ? 'selected' : '' }}>Curso
                                            </option>
                                            <option value="congreso" {{ request('type') == 'congreso' ? 'selected' : '' }}>
                                                Evento</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <select name="sort" id="sort" class="form-select filter-select">
                                            ...
                                            <option value="price_asc"
                                                {{ request('sort') == 'price_asc' ? 'selected' : '' }}>Precio: Menor a mayor
                                            </option>
                                            <option value="price_desc"
                                                {{ request('sort') == 'price_desc' ? 'selected' : '' }}>Precio: Mayor a
                                                menor</option>
                                            <option value="date_desc"
                                                {{ request('sort') == 'date_desc' ? 'selected' : '' }}>Más recientes
                                            </option>
                                            <option value="rating_desc"
                                                {{ request('sort') == 'rating_desc' ? 'selected' : '' }}>Mejor calificados
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="filter-section">
                                            ...
                                            <div class="filter-radio-item">
                                                <input class="form-check-input filter-radio-input" type="radio"
                                                    ...
                                                    onchange="this.form.submit()">
                                                <label class="form-check-label filter-radio-label"
                                                    for="visibilidadPublico">
                                                    Público
                                                </label>
                                            </div>
                                            <div class="filter-radio-item">
                                ...
                                <a href="{{ $curso->url }}" class="course-card-link">
                                    <div class="card course-card">
                                        <div class="course-image-wrapper">
                                            @if ($curso->imagen)
                                                <img src="{{ asset('storage/' . $curso->imagen) }}" class="course-image"
                                                    alt="{{ $curso->nombreCurso }}">
                                            @else
                                                <img src="{{ asset('assets/img/bg2.png') }}" class="course-image"
                                                    alt="{{ $curso->nombreCurso }}">
                                            @endif
                                        ...
                                        <div class="card-body course-card-body">
                                            ...
                                            <div class="course-stats">
                                                @if ($curso->tipo == 'Curso')
                                                    ...
                                                    <i class="bi bi-people ms-3"></i>{{ $curso->inscritos_count ?? 0 }}
                                                    estudiantes
                                                @else
                                                    <i
                                                        class="bi bi-calendar"></i>{{ \Carbon\Carbon::parse($curso->fecha_ini)->format('d M Y') }}
