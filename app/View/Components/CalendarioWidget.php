...
class CalendarioWidget extends Component
{
    ...
    public $mostrarProximasActividades;

    /**
     * Create a new component instance.
     *
     * @param string $altura Altura del calendario (ej: '600px', 'auto')
     * @param string $vista Vista inicial ('dayGridMonth', 'timeGridWeek', 'listWeek')
     * @param bool $mostrarFiltros Mostrar controles de filtros
     * @param bool $mostrarProximasActividades Mostrar lista de próximas actividades
     */
    public function __construct(
        $altura = '600px',
        $vista = 'dayGridMonth',
        $mostrarFiltros = true,
        $mostrarProximasActividades = true
    ) {
        $this->altura = $altura;
        $this->vista = $vista;
        $this->mostrarFiltros = $mostrarFiltros;
        $this->mostrarProximasActividades = $mostrarProximasActividades;
